...
/**
 * Immutable ID of a Schema.
 *
 * @see https://www.mediawiki.org/wiki/Extension:WikibaseLexeme/Data_Model#Lexeme
 *
 * @license GPL-2.0-or-later
 */
class SchemaId extends SerializableEntityId implements Int32EntityId {

	public const PATTERN = '/^S[1-9]\d{0,9}\z/i';
	...
	public function getNumericId() {
		if ( $this->isForeign() ) {
			throw new RuntimeException( 'getNumericId must not be called on foreign SchemaIds' );
		}
